...
# Build application
RUN DB_HOSTNAME=$HOSTNAME DB_USER=$USER DB_PASSWORD=$PASSWORD DB_PORT=$PORT BUCKET=$BUCKET GOOGLE_SERVICE_KEY=$GOOGLE_SERVICE_KEY OPENAI_API_KEY=$OPENAI_API_KEY npm run build

...
# Build application
RUN DB_HOSTNAME=$DB_HOSTNAME DB_USER=$DB_USER DB_PASSWORD=$DB_PASSWORD DB_PORT=$DB_PORT BUCKET=$BUCKET GOOGLE_SERVICE_KEY=$GOOGLE_SERVICE_KEY OPENAI_API_KEY=$OPENAI_API_KEY JWT_SIGNING_KEY=$JWT_SIGNING_KEY MAILGUN_KEY=$MAILGUN_KEY APP_URL=$APP_URL INSTANCE_CONNECTION_NAME=$INSTANCE_CONNECTION_NAME APP_VERSION=$APP_VERSION GOOGLE_OAUTH_CLIENT_ID=$GOOGLE_OAUTH_CLIENT_ID GOOGLE_OAUTH_CLIENT_SECRET=$GOOGLE_OAUTH_CLIENT_SECRET npm run build

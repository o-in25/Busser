...
<div class="max-w-3xl mx-auto py-8">
	<Card.Root class="glass-card p-6 md:p-8">
		...
		<div class="prose prose-zinc dark:prose-invert">
			<p class="text-muted-foreground mb-4">Last updated: January 25, 2026</p>
			...
			<!-- What are cookies? -->
			<h2 id="what-are-cookies" class="text-xl font-semibold mt-8 mb-3">What are cookies?</h2>
			...
			<p class="text-muted-foreground mb-4">
				Cookies set by the website owner (in this case, Busser) are called "first-party cookies."
			...
			<h2 id="why-cookies" class="text-xl font-semibold mt-8 mb-3">Why do we use cookies?</h2>
			...
			<h2 id="control-cookies" class="text-xl font-semibold mt-8 mb-3">How can I control cookies?</h2>
			...
			<h2 id="browser-controls" class="text-xl font-semibold mt-8 mb-3">
				How can I control cookies on my browser?
			</h2>
			...
			<h2 id="other-tracking" class="text-xl font-semibold mt-8 mb-3">
			...
			<!-- Flash cookies -->
			<h2 id="flash-cookies" class="text-xl font-semibold mt-8 mb-3">
			...
			<p class="text-muted-foreground mb-4">
				...
				Flash LSOs from being placed on your computer without your being asked, and (for Flash Player
				8 and later) how to block Flash Cookies that are not being delivered by the operator of the page
			...
			<h2 id="targeted-advertising" class="text-xl font-semibold mt-8 mb-3">
			...
			<!-- Updates -->
			<h2 id="updates" class="text-xl font-semibold mt-8 mb-3">

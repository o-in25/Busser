...
<div class="prose prose-zinc dark:prose-invert">
	...
	<p class="text-muted-foreground mb-4">
		...
		their available ingredients. The service helps users maximize their home bartending capabilities
		by matching their inventory against a catalog of classic and modern cocktail recipes.
	</p>
	...
	<p class="text-muted-foreground mb-4">
		...
		on behalf of an entity ("you"), and Busser, concerning your access to and use of the Services.
	...
	<ul class="list-disc pl-6 mb-4 text-muted-foreground">
		...
		<li class="mb-2">Delete the copyright or other proprietary rights notice from any Content.</li>
		<li class="mb-2">
		...
		<li class="mb-2">Use a buying agent or purchasing agent to make purchases on the Services.</li>
		<li class="mb-2">
	...
	<ul class="list-disc pl-6 mb-4 text-muted-foreground">
		...
		<li class="mb-2">Your Contributions do not violate any applicable law, regulation, or rule.</li>
		<li class="mb-2">
	...
	<p class="text-muted-foreground mb-4">
		...
		are exclusively between you and the applicable third party. You agree and acknowledge that we do
	...
	<p class="text-muted-foreground mb-4">
		...
		to negotiate any Dispute (except those Disputes expressly provided below) informally before
	...
	<p class="text-muted-foreground mb-4">
		...
		applicable AAA rules or applicable law, the arbitration will take place in Ohio. Except as
	...
	<p class="text-muted-foreground mb-4">
		...
		commenced or prosecuted in the state and federal courts located in Ohio, and the Parties hereby
	...
	<h3 class="text-lg font-medium mt-4 mb-2">Exceptions to Informal Negotiations and Arbitration</h3>
	...
	<p class="text-muted-foreground mb-4">
		...
		BY YOU TO US. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED

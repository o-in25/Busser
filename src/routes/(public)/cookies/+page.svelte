<svelte:head>
	...
	<meta
		name="description"
		content="Learn how Busser uses cookies and similar technologies on our website."
	/>
</svelte:head>
...
<div class="prose prose-zinc dark:prose-invert">
	...
	<!-- Contact -->
	<h2 id="contact" class="text-xl font-semibold mt-8 mb-3">Where can I get further information?</h2>

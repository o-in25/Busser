<script lang="ts">
	...
	import { Users, SlidersHorizontal } from 'lucide-svelte';
...
<Tabs.Root value="users" class="w-full">
	<Tabs.List class="grid w-full grid-cols-2 mb-4">
		<Tabs.Trigger value="general" class="flex items-center gap-2" onclick={() => window.location.href = '/settings'}>
			<SlidersHorizontal class="w-4 h-4" />General
		</Tabs.Trigger>

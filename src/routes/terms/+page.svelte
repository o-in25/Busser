...
<svelte:head>
	<title>Terms of Service - Busser</title>
</svelte:head>
...
<div class="max-w-3xl mx-auto py-8">
	<Card.Root class="glass-card p-6 md:p-8">
		...
		<div class="prose prose-zinc dark:prose-invert">
			...
			<p class="text-muted-foreground mb-4">We are Busser ("Company," "we," "us," "our").</p>
			...
			<p class="text-muted-foreground mb-4">
				Busser is a home bar management application that allows users to track their spirits and
				ingredients inventory, browse cocktail recipes, and discover which drinks they can make with
				their available ingredients. The service helps users maximize their home bartending
			...
			<p class="text-muted-foreground mb-4">
				...
				personally or on behalf of an entity ("you"), and Busser, concerning your access to and use
			...
			<ol class="list-decimal pl-6 mb-4 text-muted-foreground">
				...
				<li class="mb-1">
					<a href="#thirdparty" class="text-primary hover:underline"
				...
				<li class="mb-1">
					<a href="#california" class="text-primary hover:underline"
			...
			<!-- Section 1 -->
			<h2 id="services" class="text-xl font-semibold mt-8 mb-3">1. Our Services</h2>
			...
			<!-- Section 2 -->
			<h2 id="ip" class="text-xl font-semibold mt-8 mb-3">2. Intellectual Property Rights</h2>

			<h3 class="text-lg font-medium mt-4 mb-2">Our intellectual property</h3>
			...
			<h3 class="text-lg font-medium mt-4 mb-2">Your use of our Services</h3>
			...
			<p class="text-muted-foreground mb-4">solely for your personal, non-commercial use.</p>
			...
			<p class="text-muted-foreground mb-4">
				...
				in blogs, message boards, online forums, and other functionality during which you may create,
				...
				music, graphics, comments, reviews, rating suggestions, personal information, or other material
			...
			<p class="text-muted-foreground mb-4">
				<strong>When you post Contributions, you grant us a license (including use of your name,
					trademarks, and logos):</strong
				...
				(including, without limitation, your image, name, and voice) for any purpose, commercial, advertising,
				or otherwise, to prepare derivative works of, or incorporate into other works, your Contributions,
				and to sublicense the licenses granted in this section. Our use and distribution may occur in
			...
			<p class="text-muted-foreground mb-4">
				...
				any Contributions, we shall have the right to remove or edit any Contributions at any time without
			...
			<!-- Section 3 -->
			<h2 id="userreps" class="text-xl font-semibold mt-8 mb-3">3. User Representations</h2>
			...
			<!-- Section 4 -->
			<h2 id="userreg" class="text-xl font-semibold mt-8 mb-3">4. User Registration</h2>
			...
			<!-- Section 5 -->
			<h2 id="purchases" class="text-xl font-semibold mt-8 mb-3">5. Purchases and Payment</h2>
			...
			<!-- Section 6 -->
			<h2 id="prohibited" class="text-xl font-semibold mt-8 mb-3">6. Prohibited Activities</h2>
			...
			<p class="text-muted-foreground mb-4">As a user of the Services, you agree not to:</p>
			...
			<ul class="list-disc pl-6 mb-4 text-muted-foreground">
				...
				<li class="mb-2">Engage in unauthorized framing of or linking to the Services.</li>
				<li class="mb-2">
				...
				<li class="mb-2">Sell or otherwise transfer your profile.</li>
				<li class="mb-2">Use the Services to advertise or offer to sell goods and services.</li>
			</ul>

			<!-- Section 7 -->
			<h2 id="ugc" class="text-xl font-semibold mt-8 mb-3">7. User Generated Contributions</h2>
			...
			<ul class="list-disc pl-6 mb-4 text-muted-foreground">
				...
				<li class="mb-2">Your Contributions are not false, inaccurate, or misleading.</li>
				<li class="mb-2">
			...
			<!-- Section 8 -->
			<h2 id="license" class="text-xl font-semibold mt-8 mb-3">8. Contribution License</h2>
			...
			<!-- Section 9 -->
			<h2 id="reviews" class="text-xl font-semibold mt-8 mb-3">9. Guidelines for Reviews</h2>
			...
			<!-- Section 10 -->
			<h2 id="thirdparty" class="text-xl font-semibold mt-8 mb-3">
			...
			<!-- Section 11 -->
			<h2 id="sitemanage" class="text-xl font-semibold mt-8 mb-3">11. Services Management</h2>
			...
			<!-- Section 12 -->
			<h2 id="ppyes" class="text-xl font-semibold mt-8 mb-3">12. Privacy Policy</h2>

			<p class="text-muted-foreground mb-4">
				We care about data privacy and security. Please review our Privacy Policy:
				<a href="/privacy" class="text-primary hover:underline">https://busserapp.com/privacy</a>.
				By using the Services, you agree to be bound by our Privacy Policy, which is incorporated
				into these Legal Terms. Please be advised the Services are hosted in the United States. If
				you access the Services from any other region of the world with laws or other requirements
				governing personal data collection, use, or disclosure that differ from applicable laws in
				the United States, then through your continued use of the Services, you are transferring
				your data to the United States, and you expressly consent to have your data transferred to
				and processed in the United States.
			</p>

			<!-- Section 13 -->
			<h2 id="terms" class="text-xl font-semibold mt-8 mb-3">13. Term and Termination</h2>
			...
			<!-- Section 14 -->
			<h2 id="modifications" class="text-xl font-semibold mt-8 mb-3">
			...
			<!-- Section 15 -->
			<h2 id="law" class="text-xl font-semibold mt-8 mb-3">15. Governing Law</h2>
			...
			<!-- Section 16 -->
			<h2 id="disputes" class="text-xl font-semibold mt-8 mb-3">16. Dispute Resolution</h2>

			<h3 class="text-lg font-medium mt-4 mb-2">Informal Negotiations</h3>
			...
			<h3 class="text-lg font-medium mt-4 mb-2">Binding Arbitration</h3>
			...
			<p class="text-muted-foreground mb-4">
				...
				Ohio. Except as otherwise provided herein, the Parties may litigate in court to compel
			...
			<p class="text-muted-foreground mb-4">
				...
				commenced or prosecuted in the state and federal courts located in Ohio, and the Parties
			...
			<h3 class="text-lg font-medium mt-4 mb-2">Restrictions</h3>
			...
			<!-- Section 17 -->
			<h2 id="corrections" class="text-xl font-semibold mt-8 mb-3">17. Corrections</h2>
			...
			<!-- Section 18 -->
			<h2 id="disclaimer" class="text-xl font-semibold mt-8 mb-3">18. Disclaimer</h2>
			...
			<!-- Section 19 -->
			<h2 id="liability" class="text-xl font-semibold mt-8 mb-3">19. Limitations of Liability</h2>
			...
			<!-- Section 20 -->
			<h2 id="indemnification" class="text-xl font-semibold mt-8 mb-3">20. Indemnification</h2>
			...
			<!-- Section 21 -->
			<h2 id="userdata" class="text-xl font-semibold mt-8 mb-3">21. User Data</h2>
			...
			<!-- Section 22 -->
			<h2 id="electronic" class="text-xl font-semibold mt-8 mb-3">
			...
			<!-- Section 23 -->
			<h2 id="california" class="text-xl font-semibold mt-8 mb-3">
			...
			<!-- Section 24 -->
			<h2 id="misc" class="text-xl font-semibold mt-8 mb-3">24. Miscellaneous</h2>
			...
			<!-- Section 25 -->
			<h2 id="contact" class="text-xl font-semibold mt-8 mb-3">25. Contact Us</h2>

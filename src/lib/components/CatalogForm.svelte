<script lang="ts">
  import { Input, Label, Radio,Textarea, Hr, Heading, Card, Indicator, RadioButton, ButtonGroup, Helper  } from "flowbite-svelte";
    ...
    <fieldset class="p-4">
      ...
      <Card size="xl" class="relative">
        ...
        <div class="mb-6">
          ...
          <ul class="items-center w-full rounded-lg border border-gray-200 sm:flex dark:bg-gray-800 dark:border-gray-600 divide-x rtl:divide-x-reverse divide-gray-200 dark:divide-gray-600">
            <li class="max-w-full border-none"><Radio name="hor-list" class="p-3">Dash</Radio></li>
            <li class="max-w-full border-none"><Radio name="hor-list" class="p-3">Barspoon</Radio></li>
         
            <li class="w-full border-none"><Radio name="hor-list" class="p-3">Custom</Radio></li>

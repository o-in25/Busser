...
<Toggle on:click={toggleTheme} {checked}>Toggle me</Toggle>

<!-- <Toggle on:click={toggleTheme} aria-label={ariaLabel} type="button" {...$$restProps} class={twMerge(btnClass, $$props.class)}>Toggle me</Toggle> -->


<!-- <button on:change={toggleTheme} aria-label={ariaLabel} type="button" {...$$restProps} class={twMerge(btnClass, $$props.class)}>

<script lang="ts">
  ...
  import { Award, Droplets, Flame, Sparkles, Gauge, Candy } from "lucide-svelte";
  ...
  const ratingsMap = [
    ...
    { max: 8, label: "Connoisseur's Choice", color: "bg-emerald-500", textColor: "text-emerald-500" },
  ...
  const ratingItems = [
    ...
    { label: "Versatility", value: recipe.recipeVersatilityRating, icon: Sparkles, color: "purple" },
